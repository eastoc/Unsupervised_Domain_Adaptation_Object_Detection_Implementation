...
class ResNet_DA(BaseModule):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(ResNet_DA, self).__init__(init_cfg)
        ...
        self.da_head_top = SRM(in_channel=2048)
        self.da_head_mid = SRM(in_channel=1024)
        self.da_head_bottom = SRM(in_channel=512)
    ...
    def forward_train(self, x, gt_domain):
        ...
        return tuple(outs),da_globle_loss

    def train(self, mode=True):
        """Convert the model into training mode while keep normalization layer
        freezed."""
        super(ResNet_DA, self).train(mode)
        self._freeze_stages()
