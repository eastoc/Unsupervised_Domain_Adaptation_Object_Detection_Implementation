...
from .samplers import (DistributedGroupSampler, DistributedSampler,
                       ...
                       InfiniteGroupBatchSampler, BatchSchedulerSampler)
#from .samplers.batch_sampler import BatchSchedulerSampler
...
def build_dataloader(dataset,
    ...
    if runner_type == 'IterBasedRunner':
        ...
        if shuffle:
            ...
            #batch_sampler = BatchSchedulerSampler(dataset, samples_per_gpu) if shuffle else None
        else:
        ...
        if dist:
            ...
            sampler = BatchSchedulerSampler(dataset, samples_per_gpu) if shuffle else None
        batch_sampler = None
