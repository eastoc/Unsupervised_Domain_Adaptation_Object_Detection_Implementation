...
class StandardRoIHeadDA_cyda(BaseRoIHeadDA, BBoxTestMixin, MaskTestMixin):
    ...
    def _bbox_forward_train(self, x, sampling_results, gt_bboxes, gt_labels, gt_da,
        ...
        if (gt_da[0] == 0) & (gt_da[1] == 0): # 都为source
            ...
            flag_s = None
            flag_t = None
            for i, label_da in enumerate(gt_da):
                if label_da == 0:
                    if flag_s == None:
                        flag_s = i
                elif label_da == 1:
            ...
            gt_labels[0][flag_t] = gt_labels[0][flag_s]
            ...
            for i,roi in enumerate(rois): 
                if gt_da[i] == 0:
                    ...
                    loss_bbox = loss_bbox + self.bbox_head.loss(bbox_results_tar['cls_score'],
                                                    bbox_results_tar['bbox_pred'], roi,
                                                    *bbox_targets)
                    #print('bbox feat', bbox_feat_src.size())
